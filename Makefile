...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="sqlpgq" -DDUCKDB_OOT_EXTENSION_SQLPGQ_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_SQLPGQ_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_SQLPGQ_INCLUDE_PATH="$(PROJ_DIR)src/include"
