...
//unique_ptr<CommonTableExpressionInfo> MatchFunction::CreateCSRCTE() {
...
//					edge_table->source_fk[0], edge_element->variable_binding);
...
//					"rowid", edge_element->variable_binding);
//
