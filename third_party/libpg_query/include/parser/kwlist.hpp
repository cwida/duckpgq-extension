...
PG_KEYWORD("acyclic", ACYCLIC, PGQ_UNRESERVED_KEYWORD)
...
PG_KEYWORD("are", ARE, PGQ_UNRESERVED_KEYWORD)
...
PG_KEYWORD("cost", COST, PGQ_UNRESERVED_KEYWORD)
...
PG_KEYWORD("destination", DESTINATION, PGQ_UNRESERVED_KEYWORD)
...
PG_KEYWORD("edge", EDGE, PGQ_UNRESERVED_KEYWORD)
PG_KEYWORD("element_id", ELEMENT_ID, PGQ_UNRESERVED_KEYWORD)
...
PG_KEYWORD("graph", GRAPH, PGQ_UNRESERVED_KEYWORD)
PG_KEYWORD("graph_table", GRAPH_TABLE, RESERVED_KEYWORD)
PG_KEYWORD("group", GROUP_P, RESERVED_KEYWORD)
PG_KEYWORD("grouping", GROUPING, COL_NAME_KEYWORD)
PG_KEYWORD("grouping_id", GROUPING_ID, COL_NAME_KEYWORD)
PG_KEYWORD("groups", GROUPS, PGQ_UNRESERVED_KEYWORD)
...
PG_KEYWORD("keep", KEEP, PGQ_UNRESERVED_KEYWORD)
...
PG_KEYWORD("node", NODE, PGQ_UNRESERVED_KEYWORD)
...
PG_KEYWORD("path", PATH, PGQ_UNRESERVED_KEYWORD)
PG_KEYWORD("paths", PATHS, PGQ_UNRESERVED_KEYWORD)
...
PG_KEYWORD("properties", PROPERTIES, PGQ_UNRESERVED_KEYWORD)
PG_KEYWORD("property", PROPERTY, PGQ_UNRESERVED_KEYWORD)
...
PG_KEYWORD("relationship", RELATIONSHIP, PGQ_UNRESERVED_KEYWORD)
...
PG_KEYWORD("shortest", SHORTEST, PGQ_UNRESERVED_KEYWORD)
PG_KEYWORD("show", SHOW, UNRESERVED_KEYWORD)
PG_KEYWORD("similar", SIMILAR, TYPE_FUNC_NAME_KEYWORD)
PG_KEYWORD("simple", SIMPLE, PGQ_UNRESERVED_KEYWORD)
...
PG_KEYWORD("source", SOURCE, PGQ_UNRESERVED_KEYWORD)
...
PG_KEYWORD("trail", TRAIL, PGQ_UNRESERVED_KEYWORD)
...
PG_KEYWORD("vertex", VERTEX, PGQ_UNRESERVED_KEYWORD)
PG_KEYWORD("view", VIEW, UNRESERVED_KEYWORD)
PG_KEYWORD("views", VIEWS, UNRESERVED_KEYWORD)
PG_KEYWORD("virtual", VIRTUAL, UNRESERVED_KEYWORD)
PG_KEYWORD("volatile", VOLATILE, UNRESERVED_KEYWORD)
PG_KEYWORD("walk", WALK, PGQ_UNRESERVED_KEYWORD)
