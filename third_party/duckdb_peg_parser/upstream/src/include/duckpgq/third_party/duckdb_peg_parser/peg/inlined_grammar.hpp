...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"DescribeStatement <- DescribePropertyGraph / ShowTables / ShowSelect / ShowAllTables / ShowQualifiedName\n"
	"DescribePropertyGraph <- DescribeRule 'PROPERTY' 'GRAPH' QualifiedName\n"
	...
	"CreateStatementVariation <- CreatePropertyGraphStmt / CreateTableStmt / CreateMacroStmt / CreateSequenceStmt / CreateTypeStmt / CreateSchemaStmt / CreateViewStmt / CreateIndexStmt / CreateSecretStmt / CreateTriggerStmt\n"
	...
	"InnerTableRef <- GraphTableRef / ValuesRef / TableFunction / TableSubquery / BaseTableRef / ParensTableRef\n"
	...
	"PropertyGraphLabel <- PropertyGraphExplicitLabel / PropertyGraphImplicitLabel\n"
	...
	"GraphVertexReference <- '(' Identifier GraphTableLabel? WhereClause? ')'\n"
	...
	"GraphEdgeDash <- '-'\n"
	"GraphEdgeBody <- '[' Identifier GraphTableLabel? WhereClause? ']'\n"
