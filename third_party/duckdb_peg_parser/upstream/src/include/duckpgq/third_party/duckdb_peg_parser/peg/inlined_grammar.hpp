...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"GraphTableRef <- GraphTableKeyword '(' QualifiedName 'MATCH' GraphPathPattern 'COLUMNS' '(' TargetList ')' ')'\n"
	...
	"GraphPathPattern <- GraphVertexPattern GraphEdgeVertexPattern*\n"
	"GraphEdgeVertexPattern <- GraphEdgePattern GraphVertexPattern\n"
