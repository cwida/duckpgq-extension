...
ShortestPathState::ShortestPathState(const shared_ptr<DataChunk> &pairs_, std::vector<shared_ptr<ILocalCSR>> &local_csrs_, std::vector<std::pair<idx_t, idx_t>> &partition_ranges_, idx_t num_threads_, ClientContext &context_)
